...
const calculateWeeklyRepayment = (loanAmount: number) => {
  ...
  return (
    loanAmount *
    ((weeklyRate * (weeklyRate + 1) ** totalPayments) / ((weeklyRate + 1) ** totalPayments - 1))
  );
};
        ...
        <Stack align="center" gap="xs">
          ...
          >
            <JumboTitle
              ...
              fz="xs"
              ta="center"
              style={{ textWrap: 'balance', color: theme.colors.header[1] }}
            >
        ...
        <Grid align="center" mx="xl">
          {showWeekly && showMonthly && (
            <Grid.Col
              mt="xs"
              span="auto"
              style={{ borderRight: '4px solid', borderRightColor: theme.colors.header[0] }}
              visibleFrom="md"
            >
              <StatCell
          ...
          {showWeekly && showMonthly && (
            <Grid.Col
              ...
              span="auto"
              hiddenFrom="md"
              style={{ borderBottom: '3px solid', borderBottomColor: theme.colors.header[0] }}
            >
              <StatCell
                mb="xs"
                startValue={baseValue}
